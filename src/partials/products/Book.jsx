...
const Book = ({ book, onAddToCart }) => {
    const { title, authors, description, thumbnail, price } = book;
    ...
    return (
        ...
        //     <button onClick={() => onAddToCart(book)}>a</button>
        // </div>
        <div className="book">
                    ...
                    <div className="md:px-4 md:grid md:grid-cols-1 lg:grid-cols-1 gap-5 space-y-4 md:space-y-0">
                        <div className=" max-w-sm bg-white h-auto px-2 pt-2 pb-2 rounded-xl shadow-lg transform hover:scale-105 transition duration-500">
                            ...
                            <div className="relative flex justify-center items-center ">
                                {thumbnail && <img className="w-full max-w-[20rem] h-[20rem] rounded-xl" src={thumbnail} alt={title} /> }
                            ...
                            <h1 className="ml-3 mt-4 text-gray-800 text-2xl font-bold cursor-pointer">{title}</h1>
                            <div className="my-4">
                                ...
                                <div className="ml-3 flex space-x-1 items-center">
                                    ...
                                    {authors &&<p className="">{authors.join(', ')}</p>}
                                </div>
                                <div className="ml-3 flex space-x-1 items-center">
                                    <span>
                                        <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-indigo-600 mb-1.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                ...
                                <div class="flex justify-center items-center px-2 pb-2">
                                    ...
                                    <div class="w-1/5 p-2">
                                        <button onClick={() => onAddToCart(book)} className="flex justify-center items-center mt-4 text-xl w-10 h-10 text-green-900 hover:text-green-100 bg-green-400 hover:bg-green-600 transition-all py-2 rounded-full shadow-lg">
