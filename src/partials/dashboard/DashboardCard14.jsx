      ...
      <div>
        <div className="md:px-4 md:grid md:grid-cols-1 lg:grid-cols-1 gap-5 space-y-4 md:space-y-0">
          <div className=" max-w-sm bg-white h-auto px-2 pt-2 pb-2 rounded-xl shadow-lg transform hover:scale-105 transition duration-500">
            ...
            <h1 className="ml-3 mt-4 text-gray-800 text-2xl font-bold cursor-pointer">{truncateText(product.name, 20)}</h1>
            <div className="my-4">
              <div className="flex space-x-1 items-center">
                <p className="p-3 indent-5 text-justify break-all">{truncateText(product.description, 50)}</p>
              </div>
              ...
              <div class="flex justify-center items-center px-2 pb-2">
                <div class="w-2/3 p-2">
                <span class="px-4 py-2 font-medium  text-base rounded-full text-green-600  bg-green-200 ">
                  R$ {product.price}
                </span>
            ...
            <div class="lg:col-gap-12 xl:col-gap-16 mt-8 grid grid-cols-1 gap-12 lg:mt-12 lg:grid-cols-5 lg:gap-16">
                ...
                <div class="lg:flex lg:items-start">
                  <div class="lg:order-2 lg:ml-5">
                    <div class="max-w-xl overflow-hidden rounded-lg">
                      <img class="h-full w-full max-w-full object-cover" src={selectedProduct.img} alt={selectedProduct.name} />
                    </div>
                  </div>
                  ...
                  <div class="mt-2 w-full lg:order-1 lg:w-32 lg:flex-shrink-0">
                    <div class="flex flex-row items-start lg:flex-col">
                      <button type="button" class="flex-0 aspect-square mb-3 h-20 overflow-hidden rounded-lg border-2 border-gray-900 text-center">
                        <img class="h-full w-full object-cover" src={selectedProduct.img02} alt={selectedProduct.name} />
                      </button>
                    </div>
                  </div>
                </div>
              ...
              <div class="lg:col-span-2 lg:row-span-2 lg:row-end-2">
                ...
                <div class="mt-5 flex items-center">
                  ...
                  <p class="ml-2 text-sm font-medium text-gray-500">1,209 favoritos</p>
                </div>

                <h2 class="mt-8 text-base text-gray-900">Formato:</h2>
                <div class="mt-3 flex select-none flex-wrap items-center gap-1">
                  <label class="">
                    <input type="radio" name="type" value="E-book" class="peer sr-only" checked />
                    <p class="peer-checked:bg-black peer-checked:text-white rounded-lg border border-black px-6 py-2 font-bold cursor-pointer">E-book</p>
                  </label>
                  <label class="">
                    <input type="radio" name="type" value="Livro" class="peer sr-only" />
                    <p class="peer-checked:bg-black peer-checked:text-white rounded-lg border border-black px-6 py-2 font-bold cursor-pointer">Livro</p>
                  </label>
                </div>

                <div class="mt-10 flex flex-col items-center justify-between space-y-4 border-t border-b py-4 sm:flex-row sm:space-y-0">
                  <div class="flex items-end">
                    <h1 class="text-xl text-green-600 font-bold">R$ {selectedProduct.price}</h1>
                  </div>

                  <button type="button" class="ml-1 inline-flex items-center justify-center rounded-md border-2 border-transparent bg-gray-900 bg-none px-12 py-3 text-center text-base font-bold text-white transition-all duration-200 ease-in-out focus:shadow hover:bg-gray-800">
              ...
              <div class="lg:col-span-3">
                ...
                <div class="mt-8 flow-root sm:mt-12">
                  ...
                  <p class="mt-4 indent-5 text-justify break-all">{selectedProduct.description}</p>
