...
function DashboardCard15({ imageLinks, title, thumbnail, description, categories, authors, price }) {
      ...
      <div>
        <div className="md:px-4 md:grid md:grid-cols-1 lg:grid-cols-1 gap-5 space-y-4 md:space-y-0">
          <div className=" max-w-sm bg-white h-auto px-2 pt-2 pb-2 rounded-xl shadow-lg transform hover:scale-105 transition duration-500">
            ...
            <div
              className="bg-gray-400 w-full h-72 rounded-xl p-4 bg-no-repeat bg-center bg-cover cursor-pointer"
            ...
            <div className="my-4">
              ...
              <div class="flex justify-center items-center px-2 pb-2">
                ...
                <div class="w-1/5 p-2">
                  <button className="flex justify-center items-center mt-4 text-xl w-10 h-10 text-center bg-indigo-300 hover:bg-indigo-500 text-indigo-700 hover:text-white transition-all py-2 rounded-full shadow-lg" onClick={openModal}>
