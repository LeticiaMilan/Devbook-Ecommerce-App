...
function SignUp() {
    return (
        ...
        "
        >
            <div className="w-full max-w-sm p-4 bg-slate-900 border border-slate-800 rounded-lg shadow sm:p-6 md:p-8 dark:bg-gray-800 dark:border-gray-700">
                <form className="space-y-6" action="#">
                    {/* <div className="flex justify-center items-center text-indigo-800">
                        ...
                        />
                        <span className="text-3xl font-bold whitespace-pre text-indigo-400">DevBook</span>
                    </div> */}
                    <h5 className="text-xl font-bold text-gray-200 dark:text-white">Crie sua conta</h5>
                    <div>
                        <label htmlFor="email" className="block mb-0.5 text-sm font-medium text-gray-200 dark:text-white">Seu e-mail</label>
                    ...
                    <div>
                        <label htmlFor="password" className="block mb-0.5 text-sm font-medium text-gray-200 dark:text-white">Senha</label>
                    ...
                    <div>
                        <div className='relative'>
                            <input type="password" name="password" id="password" placeholder="Confirme sua senha" className="py-2 px-10 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-indigo-500 focus:border-indigo-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" required />
                    ...
                    <button type="submit" className="w-full text-white bg-indigo-700 hover:bg-indigo-800 focus:ring-4 focus:outline-none focus:indigo-purple-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-indigo-600 dark:hover:bg-indigo-700 dark:focus:ring-indigo-800 transition-all">Cadastrar</button>
                    
                    <div class="flex flex-row justify-center mb-8">
                        <span class="absolute bg-slate-900 px-4 text-gray-500">ou registre com</span>
                    ...
                    <div className="text-sm font-medium text-gray-500 dark:text-gray-300">
                        ...
                        <a href="#" className="ml-2 text-indigo-700 hover:font-bold dark:text-indigo-500 transition-all">
                            <Link to="/signin">
                                Logar
                            </Link>
                        </a>
